...
export default async function Footer({ locale }) {
  ...
  return (
    <FooterBackground>
      ...
      <h1 className="max-w-[95%] text-3xl lg:text-5xl z-30 text-white text-center max-lg:mt-5">
      ...
      <div className="w-full mt-20 max-w-[1600px] flex flex-col justify-center items-center xl:flex-row xl:justify-between xl:items-start z-30 border-2 border-white p-10 rounded-xl">
