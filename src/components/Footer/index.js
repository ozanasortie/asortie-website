...
export default async function Footer({ locale }) {
  ...
  return (
    <FooterBackground>
      ...
      <h1 className="w-[90%] text-3xl lg:text-4xl z-30 text-white text-center max-lg:mt-5">
      ...
      <div className="w-full mt-20 max-w-[1500px] 2xl:max-w-[1700px] flex flex-col justify-center items-center xl:flex-row xl:justify-between xl:items-start z-30 border border-gray-500 p-10 rounded-xl">
        ...
        <div className="w-[95%] lg:pl-4 2xl:pl-0 lg:h-[360px] xl:w-[70%] flex flex-col lg:items-start justify-between text-white">
          ...
          <div className="mb-8 z-30 max-w-[1600px] w-full px-4 text-white leading-6 flex flex-wrap text-sm">
            ...
            <NavLink href="/corporate/biz-kimiz" className="m-2 font-normal">
              {t("yasal_uyarilar")}
            </NavLink>
