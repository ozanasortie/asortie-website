...
export default function ListProduct({ href, image, secondImage, title }) {
  return (
    <Link
      className="box-border w-[97%] h-72 md:h-96 lg:h-[400px] cursor-pointer relative overflow-hidden flex items-center justify-center text-2xl group"
      href={href}
    >
      <motion.div
      ...
      >
        ...
        <div className="text-0 text-center text-xl lg:text-[20px] relative bg-white w-full">
