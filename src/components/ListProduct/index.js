...
export default function ListProduct({ image, secondImage, title }) {
  return (
    <motion.div
      ...
      className="box-border w-[95%] lg:w-[48%] h-72 md:h-96 lg:h-[400px] mb-6 cursor-pointer relative overflow-hidden flex flex-col items-center justify-center text-2xl group"
    >
