...
export default function RecommendedSlider() {
  ...
  return (
    <Slider className="z-30 w-full " {...settings}>
      <div>
        <div
          className={`bg-no-repeat bg-center bg-cover h-[65vh] w-full flex flex-col items-center justify-center text-white`}
        ...
        >
          ...
          >
            ...
            geleceğin mirasıyla buluşturuyoruz. Her modelimizs, geleceğin
