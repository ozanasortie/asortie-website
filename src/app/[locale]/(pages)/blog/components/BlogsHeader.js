...
function BlogsHeader() {
  return (
    ...
    >
      <h1 className="w-full text-center font-light mb-3 text-xl lg:text-3xl">BLOG</h1>
      <h1 className="flex items-center mt-1 mb-4 ml-8 text-3xl lg:text-5xl text-center">Takım arkadaşlarımızdan yazılar <QuillWrite01Icon size={32} className="ml-3"/></h1>
