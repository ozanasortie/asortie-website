...
function BlogsHeader({ t }) {
  return (
    <Transition
      ...
      className="pt-28 lg:pt-40 lg:max-w-[1000px] xl:max-w-[1400px] w-[100%] flex items-center flex-col text-black px-4 mb-4"
    >
      <h1 className="w-full text-center font-light mb-3 text-xl lg:text-3xl">
        {t("haberler")}
      </h1>
      <h1 className="flex items-center mt-1 mb-4 ml-8 text-3xl lg:text-4xl text-center">
        {t("haberler_liste_baslik")}
