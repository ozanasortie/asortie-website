...
export default function CollectionItem({ image, secondImage, title }) {
  return (
    ...
    >
      ...
      >
        <div className="text-0 text-center lg:text-start text-xl relative w-full h-full">
          <h2 className="motion-safe:transition py-5 lg:text-5xl font-light">
            {title}
          </h2>
          <p className="w-[95%] lg:text-lg">
          ...
          <Button
            ...
            color="white"
            background="black"
            className={"w-fit p-4 h-[45px] mt-5 !rounded-none"}
          />
        </div>
