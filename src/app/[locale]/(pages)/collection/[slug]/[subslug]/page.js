...
export default async function ProductDetail({ params }) {
  ...
  return (
    <div className="w-full relative flex flex-col items-center pb-16 overflow-x-hidden pt-24">
      ...
      />
      <Transition className="max-w-[1500px] 2xl:max-w-[1700px] w-[97%] lg:w-[90%] bg-cover bg-center bg-no-repeat flex flex-col lg:flex-row lg:justify-center text-black p-4">
      ...
      <div
        className="hidden lg:block text-start w-[97%] lg:w-[90%] max-w-[1500px] 2xl:max-w-[1700px] px-6 text-gray-800 mt-24"
        dangerouslySetInnerHTML={{ __html: data.Urunler[0].urun_detayi }}
      />
