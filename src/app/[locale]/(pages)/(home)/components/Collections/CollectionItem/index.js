...
const CollectionItem = ({ image, secondImage, title, className }) => {
  return (
    <div
      className={`box-border h-56 w-full lg:h-80 mb-5 mx-2 cursor-pointer relative overflow-hidden flex flex-col items-center justify-center text-2xl group ${className}`}
    >
