...
export default function CatalogueFormSection() {
  ...
  return (
    <div
      className={`bg-cover bg-center relative py-20 lg:pb-24 flex justify-center items-center text-white ${
        isSafari ? "" : "bg-fixed"
      }`}
    ...
    >
      ...
      <div className="w-full max-w-[1000px] lg:max-w-[1500px] 2xl:max-w-[1700px] px-4 lg:px-page flex flex-col lg:flex-row items-center lg:justify-around">
        <motion.div
        ...
        >
          ...
          <Button
            background="white"
            color="black"
            className="w-[60%] flex items-center justify-center py-4"
        ...
        >
          <motion.div
            ...
            className="w-full flex items-center justify-start mt-10 mb-2 z-30"
          >
