...
export default function AboutUs({ t }) {
  return (
    <BackgroundSection
      ...
      className="bg-cover bg-center relative lg:p-0 flex flex-col items-center justify-center text-white"
    >
      <div className="absolute left-0 top-0 w-full h-full bg-black bg-opacity-35 z-30" />
      <div className="max-w-[1500px] 2xl:max-w-[1700px] flex flex-col w-full z-30 px-4 lg:px-page">
        <div className="flex flex-col lg:flex-row items-center lg:items-center py-8">
          <Transition
            ...
            className="lg:w-[100%] max-w-[600px] h-full max-lg:mb-8"
          >
            <img
