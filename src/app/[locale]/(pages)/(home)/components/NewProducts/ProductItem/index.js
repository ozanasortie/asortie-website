...
const ProductItem = ({ image, secondImage, title }) => {
  return (
    <div className="box-border w-[98%] h-72 md:h-96 lg:h-[350px] cursor-pointer relative overflow-hidden flex flex-col items-center justify-center text-2xl group">
