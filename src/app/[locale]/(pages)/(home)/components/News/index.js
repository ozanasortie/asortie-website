...
export default function News({ t, news }) {
  return (
    <div className="w-full relative flex flex-1 justify-center items-center max-lg:flex-col mt-4 mb-10">
      <div className="absolute left-0 top-0 w-full bg-black bg-opacity-35" />
      <div className="max-w-[1000px] xl:max-w-[1500px] 2xl:max-w-[1700px] w-full flex flex-col items-center justify-center z-20 px-4 lg:px-page">
        <Transition
